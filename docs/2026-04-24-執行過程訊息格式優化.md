...
ℹ️ [資訊] 設備型號: A920
ℹ️ [資訊] 製造商: PAX
ℹ️ [資訊] Android 版本: 7.1.1
ℹ️ [資訊] SDK 版本: 25
ℹ️ [資訊] 設備名稱: A920    ← 移除此項
```
...
ℹ️ [資訊] Android 版本: 7.1.1
ℹ️ [資訊] SDK 版本: 25
ℹ️ [資訊] 設備序號 (SN): A920ABC123456    ← 新增
```
...
```
✅ 成功獲取：
ℹ️ [資訊] 設備序號 (SN): A920ABC123456

⚠️ 無法獲取：
⚠️ [警告] 設備序號 (SN): 無法獲取

⚠️ 接口不可用：
⚠️ [警告] 設備序號 (SN): 系統接口不可用

❌ 獲取失敗：
⚠️ [警告] 設備序號 (SN): 獲取失敗 - [錯誤信息]
```
...
```
ℹ️ [資訊] ========== 硬體管理器測試 ==========
ℹ️ [資訊] HardwareManager 實例: 正常
✅ [成功] 檢測到 PAX 設備
ℹ️ [資訊] Helper 類型: PaxHelper
ℹ️ [資訊] --- PAX 特定功能測試 ---
ℹ️ [資訊] PaxHelper 實例: 正常
ℹ️ [資訊] --- 測試通用接口 ---
ℹ️ [資訊] ✓ cSys 接口可用
